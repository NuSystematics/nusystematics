...
if(DEFINED BUILD_AR25_FSI_DIALS)
  message(STATUS "BUILD_AR25_FSI_DIALS is set from CMake command")
  message(STATUS "BUILD_AR25_FSI_DIALS: ${BUILD_AR25_FSI_DIALS}")
else()
  message(STATUS "BUILD_AR25_FSI_DIALS is not set, so using GENIE Version for the decision")
