...
ValenciaExc2p2hReweighter::ValenciaExc2p2hReweighter(YAML::Node const &params)
    :IGENIESystProvider_tool(params),
    pidx_DialValencia(systtools::kParamUnhandled<size_t>),
    scale_factor_pp(1.0), scale_factor_pn(1.0)
    {}

SystMetaData ValenciaExc2p2hReweighter::BuildSystMetaData(YAML::Node const &cfg, paramId_t firstId) {
    ...
    std::string JSON_PP_REWEIGHTER_PATH = cfg["JSON_PP_REWEIGHTER_PATH"] ? cfg["JSON_PP_REWEIGHTER_PATH"].as<std::string>() : "";
    tool_options["JSON_PP_REWEIGHTER_PATH"] = JSON_PP_REWEIGHTER_PATH;
    std::string JSON_PN_REWEIGHTER_PATH = cfg["JSON_PN_REWEIGHTER_PATH"] ? cfg["JSON_PN_REWEIGHTER_PATH"].as<std::string>() : "";
    tool_options["JSON_PN_REWEIGHTER_PATH"] = JSON_PN_REWEIGHTER_PATH;
    ...
    scale_factor_pp = cfg["SCALE_FACTOR_PP"] ? cfg["SCALE_FACTOR_PP"].as<double>() : 2.4642232350453983;
    tool_options["SCALE_FACTOR_PP"] = scale_factor_pp;
    scale_factor_pn = cfg["SCALE_FACTOR_PN"] ? cfg["SCALE_FACTOR_PN"].as<double>() : 1.6862982652296663;
    tool_options["SCALE_FACTOR_PN"] = scale_factor_pn;

    return smd;
}

bool ValenciaExc2p2hReweighter::SetupResponseCalculator(YAML::Node const &tool_options) {
    ...
    std::string JSON_PP_REWEIGHTER_PATH = tool_options["JSON_PP_REWEIGHTER_PATH"] ? tool_options["JSON_PP_REWEIGHTER_PATH"].as<std::string>() : "";
    std::string JSON_PN_REWEIGHTER_PATH = tool_options["JSON_PN_REWEIGHTER_PATH"] ? tool_options["JSON_PN_REWEIGHTER_PATH"].as<std::string>() : "";
    ...
    scale_factor_pp = tool_options["SCALE_FACTOR_PP"] ? tool_options["SCALE_FACTOR_PP"].as<double>() : 2.4642232350453983;
    std::cout << "[ValenciaExc2p2hReweighter::SetupResponseCalculator] use SCALE_FACTOR_PP = "<< scale_factor_pp << std::endl;
    scale_factor_pn = tool_options["SCALE_FACTOR_PN"] ? tool_options["SCALE_FACTOR_PN"].as<double>() : 1.6862982652296663;
